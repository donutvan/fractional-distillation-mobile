...
public class reboiler_animation : MonoBehaviour
{
    ...
    {
        StartCoroutine(liquidMoleculeTubeAnimation(reboilerLiquid1Prefab, 0.3f, 17));
        ...
        boiling.transform.localPosition = new Vector3(500, 200, 0);
        ...
        StartCoroutine(vapourSpawnPoints(60));
    ...
    */
    ...
    {
        float period = 3f;
        float initialYpos = transform.position.y - (7 * SCALE);
        ...
        while (true)
        {
            ...
            GameObject vapourInstance = (GameObject)Instantiate(columnVapourPrefab);
